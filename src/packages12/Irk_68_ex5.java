...
/*
    Write this code in notepad***g

   you have to create a package named com.irshad.shape
   This package should have individual classes for Rectangle ,Square,Cylinder,Sphere
   The classes should use inheritance to properly to manage the code
   Include methods like volume, surface area and getters/ setters for dimensions
 */
//public class Irk_68_ex5 {
